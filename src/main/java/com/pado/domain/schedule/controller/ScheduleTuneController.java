...
public class ScheduleTuneController {
    ...
    @Operation(
        summary = "조율 생성",
        description = "스터디 리더가 조율을 생성합니다(조율 기간/시간대·슬롯 간격을 기반으로 슬롯을 자동 생성하며, 멤버별 candidate_number를 부여합니다).",
    ...
    @ApiResponse(responseCode = "400", description = "유효성 오류", content = @Content(
        ...
        examples = @ExampleObject(name = "INVALID_INPUT", value = """
    ...
    public ResponseEntity<Void> createScheduleTune(
        ...
        @Valid @RequestBody(
            ...
            content = @Content(
                ...
                examples = @ExampleObject(name = "create_tune", value = """
                        {
                          "title": "주간 정기 회의",
                          "content": "안건: 진행상황 점검",
        ...
        ) ScheduleTuneCreateRequestDto request
    ) {
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(
        ...
        examples = @ExampleObject(name = "list_tunes", value = """
                [
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(
        ...
        examples = @ExampleObject(name = "tune_detail", value = """
                {
                  "title":"주간 정기 회의",
                  "description":"안건: 진행상황 점검",
                  "candidate_dates":[3,5,0,1],
    ...
    @ApiResponse(responseCode = "200", description = "참여 반영 성공", content = @Content(
        ...
        examples = @ExampleObject(name = "participate_ok", value = """
            { "message":"updated" }
            """)))
    @ApiResponse(responseCode = "400", description = "유효성 오류", content = @Content(
        schema = @Schema(implementation = ErrorResponseDto.class),
    ...
    public ResponseEntity<ScheduleTuneParticipantResponseDto> participateInScheduleTune(
        ...
        @Valid @RequestBody(
            ...
            content = @Content(
                ...
                examples = @ExampleObject(name = "participate", value = """
                    { "candidate_dates":[1,0,1,0] }
                    """)
            )
    ...
    @Operation(
        summary = "조율 완료",
        description = "최다 참여 슬롯이 아니라, 요청한 시작/종료가 생성된 슬롯 경계와 정확히 일치해야 합니다(일치 시 일정 생성 + status=COMPLETED 전이).",
        security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponse(responseCode = "200", description = "완료 성공", content = @Content(
        ...
        examples = @ExampleObject(name = "complete_ok", value = """
            { "success":true }
            """)))
    @ApiResponse(responseCode = "400", description = "유효성 오류", content = @Content(
        schema = @Schema(implementation = ErrorResponseDto.class),
    ...
    public ResponseEntity<ScheduleCompleteResponseDto> completeScheduleTune(
        ...
        @Valid @RequestBody(
            ...
            content = @Content(
                ...
                examples = @ExampleObject(name = "complete", value = """
                        {
                          "title":"확정 회의",
                          "content":"최종 안건",
                          "starttime":"2025-09-21T10:00:00",
                          "endtime":"2025-09-21T11:00:00"
                        }
                    """)
            )

...
public interface ScheduleRepository extends JpaRepository<Schedule, Long> {
    ...
    Optional<Schedule> findTopByStudyIdAndStartTimeAfterOrderByStartTimeAsc(Long studyId,
        LocalDateTime startTime);

    int countAllByStudyId(Long studyId);

    List<Schedule> findByStudyIdAndStartTimeBefore(Long studyId, LocalDateTime now);
}
...
@ApiResponses(@ApiResponse(responseCode = "400", description = "입력값 유효성 검증 실패",
        content = @Content(
                ...
                examples = @ExampleObject(
                        name = "후보 날짜 유효성 실패 예시",
                        value = "{\"error_code\": \"INVALID_CANDIDATE_DATES\", \"field\": \"candidate_dates\", \"message\": \"후보 날짜 정보는 필수 입력 항목입니다.\"}"
                ))))
public @interface Api400InvalidCandidateDatesError {
}

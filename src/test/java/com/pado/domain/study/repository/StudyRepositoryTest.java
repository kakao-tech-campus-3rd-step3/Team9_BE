...
class StudyRepositoryTest {
    ...
    void setUp() {
        ...
        study1 = Study.builder()
            ...
            .maxMembers(10)
            .build();
        study1.updateInterests(List.of(Category.PROGRAMMING, Category.EMPLOYMENT)); // 수정됨
        ...
        study2 = Study.builder()
            ...
            .maxMembers(10)
            .build();
        study2.updateInterests(List.of(Category.PROGRAMMING)); // 수정됨
        ...
        study3 = Study.builder()
            ...
            .maxMembers(10)
            .build();
        study3.updateInterests(List.of(Category.EMPLOYMENT, Category.LANGUAGE)); // 수정됨
        ...
        study4 = Study.builder()
            ...
            .maxMembers(10)
            .build();
        study4.updateInterests(List.of(Category.EMPLOYMENT)); // 수정됨
    ...
    void 로그인사용자_필터없음_추천점수_최신순으로정렬() {
        ...
        Slice<Study> result = studyRepository.findStudiesByFilter(testUser, null, null, null,
            pageable);
    ...
    void 로그인사용자_필터있음_필터링된결과_추천점수순으로정렬() {
        ...
        // when
        Slice<Study> result = studyRepository.findStudiesByFilter(testUser, null, categoryFilter,
            regionFilter, pageable);
    ...
    void 비로그인사용자_필터있음_필터링된결과_최신순으로정렬() {
        ...
        // when
        Slice<Study> result = studyRepository.findStudiesByFilter(null, null, categoryFilter, null,
            pageable);

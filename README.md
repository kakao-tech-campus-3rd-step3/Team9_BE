...
단순한 스터디 관리를 넘어, **게이미피케이션 요소**와 **AI 퀴즈 생성**을 통해 멤버들의 학습 동기를 부여하고, **스마트 일정 조율**과 **진척도 관리** 기능으로 스터디 운영의 효율성을 극대화합니다.
...
- 
    ...
    **🤖 AI 퀴즈 자동 생성:** **Google Gemini AI (gemini-2.5-flash)** 와 연동하여, 사용자가 업로드한 학습 자료(PDF, TXT 등 15)의 본문을 분석해 객관식/주관식 퀴즈를 자동으로 생성합니다.
